...
export function appendNestedReplies({ nestedReplies }) {
  // const $nestedReplyData = document.getElementById("nestedReplyCollapse").closest('#nestedReplyData');
  const $nestedReplyData = document.getElementById('nestedReplyData'); // 업스넉
